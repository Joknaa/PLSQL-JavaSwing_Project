INSERT INTO clientlist VALUES(1, 'BENTAJER','Mhannech II, Tetouan', 1, '2019-11-02', 'ahmed@mail.com',
                              'A passé une grosse commande en janvier 2018 ; depuis, plus rien. Penser à reprendre contact');
INSERT INTO clientlist VALUES(2, 'ESSEGHIRI','Res Naoufal app 8, Maarif, Casablanca', 2, '2018-10-27', 'youssef@mail.com',
                              'Client contactée grâce à M. Houty de Casablanca. Remise de 10% sur ladernière commande suite à un retard d’envoi');
INSERT INTO clientlist VALUES(3, 'Belmir', 'Tetouan', 2, '2018-11-20', 'karim@mail.com',
...
INSERT INTO command VALUES(886, '2019-02-01', 2, 'A01', 10, 0);
INSERT INTO command VALUES(886, '2019-02-01', 2, 'A02', 2, 0);
INSERT INTO command VALUES(886, '2019-02-01', 2, 'B15', 1, 0);
